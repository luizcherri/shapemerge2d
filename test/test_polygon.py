from pyshapemerge2d import Polygon,Vertex,vvector,Line
...
def test_polygon_intersect_line1():
    polya=Polygon(vvector([
        Vertex(0,0),Vertex(10,0),Vertex(10,10),Vertex(0,10)]))
    ls=list(polya.intersect_line(Line(Vertex(-5,5),Vertex(15,5))))
    print ls
    assert ls==[Line(Vertex(0,5),Vertex(10,5))]
...
def test_polygon_intersect_line6():
    polya=Polygon(vvector([
        Vertex(0,0),Vertex(10,0),Vertex(10,10),Vertex(0,10)]))
    ls=list(polya.intersect_line(Line(Vertex(15,5),Vertex(-5,5))))
    print ls
    assert ls==[Line(Vertex(10,5),Vertex(0,5))]
...
def test_polygon_intersect_line8():
    ...
    ls=list(polya.intersect_line(Line(Vertex(5,5),Vertex(15,5))))
    print ls
    assert ls==[Line(Vertex(5,5),Vertex(10,5))]
                
def test_polygon_intersect_line9():
    polya=Polygon(vvector([
        Vertex(0,0),Vertex(10,0),Vertex(10,10),Vertex(0,10)]))
    ls=list(polya.intersect_line(Line(Vertex(-5,5),Vertex(5,5))))
    print ls
    assert ls==[Line(Vertex(0,5),Vertex(5,5))]

def test_polygon_intersect_line10():
    polya=Polygon(vvector([
        Vertex(0,0),Vertex(10,0),Vertex(10,10),Vertex(0,10)]))
    ls=list(polya.intersect_line(Line(Vertex(2,5),Vertex(8,5))))
    print ls
    assert ls==[Line(Vertex(2,5),Vertex(8,5))]
                
def test_polygon_intersect_line11():
    polya=Polygon(vvector([
        Vertex(0,0),Vertex(10,0),Vertex(10,10),Vertex(0,10)]))
    ls=list(polya.intersect_line(Line(Vertex(2,15),Vertex(8,15))))
    print ls
    assert ls==[]
...
def test_polygon_intersect_line12():
    polya=Polygon(vvector([
        Vertex(0,0),Vertex(10,0),Vertex(10,10),Vertex(0,10)]))
    ls=list(polya.intersect_line(Line(Vertex(0,5),Vertex(10,5))))
    print ls
    assert ls==[Line(Vertex(0,5),Vertex(10,5))]
...
def test_polygon_intersect_line13():
    polya=Polygon(vvector([
        Vertex(0,0),Vertex(10,0),Vertex(10,10),Vertex(0,10)]))
    ls=list(polya.intersect_line(Line(Vertex(5,15),Vertex(-5,5))))
    print ls
    assert ls==[Line(Vertex(0,10),Vertex(0,10))]

def test_polygon_intersect_line14():
    polya=Polygon(vvector([
        Vertex(0,0),Vertex(10,0),Vertex(10,10),Vertex(0,10)]))
    ls=list(polya.intersect_line(Line(Vertex(10,15),Vertex(10,-5))))
    print ls
    assert ls==[Line(Vertex(10,10),Vertex(10,0))]
...
def test_polygon_intersect_line16():
    ...
    ls=list(polya.intersect_line(Line(Vertex(10,-15),Vertex(10,5))))
    print ls
    assert ls==[Line(Vertex(10,0),Vertex(10,5))]
def test_polygon_intersect_line17():
    polya=Polygon(vvector([
        Vertex(0,0),Vertex(10,0),Vertex(10,10),Vertex(0,10)]))
    ls=list(polya.intersect_line(Line(Vertex(10,7),Vertex(10,5))))
    print ls
    assert ls==[Line(Vertex(10,7),Vertex(10,5))]
def test_polygon_intersect_line18():
    polya=Polygon(vvector([
        Vertex(0,0),Vertex(10,0),Vertex(10,10),Vertex(0,10)]))
    ls=list(polya.intersect_line(Line(Vertex(10,10),Vertex(15,15))))
    print ls
    assert ls==[Line(Vertex(10,10),Vertex(10,10))]

def test_polygon_intersect_line19():
    polya=Polygon(vvector([
        Vertex(0,0),Vertex(10,0),Vertex(10,10),Vertex(0,10)]))
    ls=list(polya.intersect_line(Line(Vertex(5,5),Vertex(15,15))))
    print ls
    assert ls==[Line(Vertex(5,5),Vertex(10,10))]
...
def test_polygon_intersect_line21():
    polya=Polygon(vvector([
        Vertex(0,0),Vertex(10,0),Vertex(10,5),Vertex(5,5),Vertex(5,10),Vertex(0,10)]))
    ls=list(polya.intersect_line(Line(Vertex(0,5),Vertex(10,4))))
    print ls
    assert ls==[Line(Vertex(0,5),Vertex(10,4))]
...
def test_polygon_intersect_line22():
    polya=Polygon(vvector([
        Vertex(0,0),Vertex(10,0),Vertex(10,5),Vertex(5,5),Vertex(5,10),Vertex(0,10)]))
    ls=list(polya.intersect_line(Line(Vertex(2,7),Vertex(2,7))))
    print ls
    assert ls==[Line(Vertex(2,7),Vertex(2,7))]
    
def test_polygon_intersect_line23():
    polya=Polygon(vvector([
        Vertex(0,0),Vertex(10000,0),Vertex(10000,10000),Vertex(0,10000)]))
    ls=list(polya.intersect_line(Line(Vertex(-5000,5000),Vertex(15000,5000))))
    print ls
    assert ls==[Line(Vertex(0,5000),Vertex(10000,5000))]
def test_polygon_intersect_line23():
    polya=Polygon(vvector([
